...
| **Modificabilidad / Flexibilidad (Adaptabilidad)** | RNF-02, RNF-10 | **Crítica** (RNF-02) | Cada tenant configura reglas, KYC, tiempos y comisiones sin desarrollo específico. Patrones: Strategy Pattern + configuración externalizada (reglas como datos) + **Feature Toggles** (activar/desactivar categorías de servicio y funcionalidades por tenant sin nuevo despliegue, RNF-10 / RF-10) |
...
| Estímulo | Cambia una regla de negocio o activa/desactiva una categoría de servicio (orden del listado, categorías, tarifas, documentos KYC) desde la configuración del tenant |
| Artefacto | Motor de reglas / configuración externalizada + Feature Toggles |
